...
- **Actions**:
  - **BETRAY**: Steal 1 heart. Success prevents your personal "Bleed" for that cycle.
  - **PROTECT**: Shield another unit (Cost: 1 Heart).
  - **SACRIFICE**: Instantly terminate your partner (Cost: 2 Hearts).
  - **QUIT**: Coward's exit. Terminate your unit; all other units gain +1 Heart.
